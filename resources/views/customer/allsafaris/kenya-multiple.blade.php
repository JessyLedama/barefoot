...
<div>
    <img src="/images/lion-cub-playing.jpg" alt="" class="photo-cover-pages">
    <h4 class="safari-cover-caption">
        Kenya Multiple Day Safaris
    </h4>
    
    <div class="section-experiences">
        <a href="">
            {{ $kenyaMultipleDaySafarisCount }} Experiences
        </a>
    </div>
    <h1 class="section-content-title">KENYA MULTIPLE SAFARIS</h1>
