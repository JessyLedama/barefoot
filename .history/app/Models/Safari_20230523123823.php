...
{
    protected $fillable = ['name', 'slug', 'price_from','residents_price', 'non_residents_price', 'entry_fee','transport','tour_guide', 'drinks', 'lunch', 'dinner', 'accomodation','shortDescription', 'description', 'location', 'map', 'link', 'featured', 'cover', 'gallery', 'subcategoryId', 'categoryId', 'itineraryId',];
