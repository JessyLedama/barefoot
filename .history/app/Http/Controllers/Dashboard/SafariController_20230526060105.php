...
class SafariController extends Controller
{
    ...
    public function store(StoreSafariRequest $request)
    {
        ...
        $slug = strtolower(str_re)

        $safari = Safari::create($request->except(['cover', 'gallery', 'featured']) + [
        ...
        $itineraryData = Itinerary::create([
        ...
        return redirect()->route('safari.edit', $safari);
    }
