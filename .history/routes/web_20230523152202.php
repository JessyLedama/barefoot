...
Route::prefix('dashboard')->middleware(['auth', ])->group(function () {
    Route::prefix('categories')->group(function(){
        ...
        Route::get('create', [CategoryController::class, 'create'])->name('admin.categories.index');
        Route::post('create', [CategoryController::class, 'index'])->name('admin.categories.index');
    });
