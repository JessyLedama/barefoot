...
Route::prefix('dashboard')->middleware(['auth', ])->group(function () {    
    ...
    Route::prefix('subcategories')->group(function(){
        Route::get('index', [SubCategoryController::class, 'index'])->name('admin.categories.index');
        Route::get('create', [SubCategoryController::class, 'create'])->name('admin.categories.create');
        Route::post('create', [SubCategoryController::class, 'store'])->name('admin.categories.store');
    });
