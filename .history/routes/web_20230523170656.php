...
Route::prefix('dashboard')->middleware(['auth', ])->group(function () { 
    ...
    Route::prefix('safaris')->group(function(){
        Route::get('index', [SubCategoryController::class, 'index'])->name('admin.safaris.index');
        Route::get('create', [SubCategoryController::class, 'create'])->name('admin.safaris.create');
        Route::post('create', [SubCategoryController::class, 'store'])->name('admin.safaris.store');
        Route::get('edit', [SubCategoryController::class, 'edit'])->name('admin.safaris.edit');
        Route::get('/delete', [SubCategoryController::class, 'destroy'])->name('admin.safaris.destroy');
    });
